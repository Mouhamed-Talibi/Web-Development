            ...
            <div class="card-body">
                ...
                <form action="{{ route('profiles.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="firstName" value="{{ old('firstName')}}" class="form-control shadow-sm">
                    </div>

                    {{-- Last Name --}}
                    <div class="mb-3">
                        <label class="form-label fw-bold">Nom</label>
                        <input type="text" name="lastName" value="{{ old('lastName')}}" class="form-control shadow-sm">
                    </div>

                    {{-- Age --}}
                    <div class="mb-3">
                        <label class="form-label fw-bold">Âge</label>
                        <input type="number" name="age" value="{{ old('age')}}" class="form-control shadow-sm" placeholder="ex: 25">
                    </div>

                    {{-- Email --}}
                    <div class="mb-3">
                        <label class="form-label fw-bold">Email</label>
                        <input type="email" name="email" value="{{ old('email')}}" class="form-control shadow-sm" placeholder="example@gmail.com">
                    </div>
